...
public class EmailUtils {
    ...
    // Mật khẩu ứng dụng 16 số (Viết liền, không có dấu cách)
    private static final String MY_PASSWORD = "patdfhyzlaelsrdg";
    ...
    public static void sendVerificationEmail(String toEmail, String token) {
        ...
        try {
            ...
            String content = "<div style='font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 10px;'>"
                    ...
                    + "<span style='font-size: 28px; font-weight: bold; background: #f4f4f4; padding: 15px 25px; border-radius: 8px; letter-spacing: 5px; color: #333;'>" + token + "</span>"
                    + "</div>"
